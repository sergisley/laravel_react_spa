...
export default function Login() {
    ...
    return (
            <Hero className={'p-2 bg-base-300 min-h-full h-full items-center '}>
                <Hero.Content className='flex lg:flex-row-reverse flex-col items-center px-6 py-8 mx-auto md:h-screen lg:py-0 justify-center'>

                    <div className='text-center lg:text-left p-4 '>
                        <h1 className='text-base-content text-5xl font-bold'>Company!</h1>
                        <p className='py-6 text-base-content'>
                            Magnis ultricies sed volutpat et urna egestas nisl aliquet adipiscing suspendisse mollis a
                            sit
                            accumsan scelerisque nascetur curabitur nisi nascetur auctor leo consectetur ad ultrices.Et
                            condimentum tellus.
                        </p>
                    ...
                    <Card className="flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 bg45degree">
                        ...
                        <form className='card-body' action='#' onSubmit={handleSubmit}>
                            ...
                            <div className='form-control bg-transparent border-0'>
                                <Button className="btn-primary btn btn-wide active:bg-green-200" type='submit'>Logar</Button>
                            </div>
                            ...
                            <div className='form-control mt-6 bg-transparent border-0'>
